...
function TSPsuccessPage({ params }: { params: { interestsId: string } }) {
    ...
    const invLinks = [
        ...
        {
          title: "writing",
          url: "writing group invitation link",
        },
        {
          title: "drawing",
          url: "drawing group invitation link",
        }, */
    ];
    ...
    return (
        <div className='mb-8'>
            <div className={"my-4 text-2xl text-purple-700 " + poppins.className}>Your response has been submitted!🎉</div>
            <div className="my-2">
                <h2 className={"my-4 text-xl  text-purple-800 " + poppins.className}>Join the respective groups...</h2>
