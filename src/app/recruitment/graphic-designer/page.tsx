...
export default function GdForm() {
  ...
  const onSubmit = async (formData: GdSheetData) => {
    ...
    const Q13_gd_link = formData.Q13_gd
      ? await uploadFile(formData.Q13_gd)
      : "";
        ...
        <form className="mt-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="py-5 px-6 lg:px-8 flex flex-col">
              ...
              {errors.Q5_gd && (
                <span className="text-red-500 text-xs">
                  Please select at least one editing software.
                </span>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-row bg-white bg-opacity-15 shadow-md rounded-lg mb-4">
            <div className="py-5 px-6 lg:px-8 flex flex-col">
              ...
              <p className={poppins.className + " text-slate-300 text-sm mb-4"}>
                We want to gauge your insight and your ability to understand
                trends in the world, and this question will help us do it.
              </p>
              <input
                className="border-b border-gray-300 text-white bg-transparent focus:outline-none focus:border-purple-600 focus:border-b-2 py-1 focus:placeholder-purple-400"
                placeholder="Your Answer"
          ...
          <div className="flex flex-row bg-white bg-opacity-15 shadow-md rounded-lg mb-4">
            <div className="py-5 px-6 lg:px-8 flex flex-col">
              ...
              <p className={poppins.className + " text-slate-300 text-sm mb-4"}>
                Be absolutely honest, we pride ourselves on accepting and
                improving with feedback. If you tell us something that you can
                make better, that will be a bonus point to you.
              </p>
              <input
                className="border-b border-gray-300 text-white bg-transparent focus:outline-none focus:border-purple-600 focus:border-b-2 py-1 focus:placeholder-purple-400"
