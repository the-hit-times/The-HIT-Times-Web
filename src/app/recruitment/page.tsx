    ...
    <div className="min-h-screen bg-gray-200">
      <div className="max-w-3xl mx-auto">
        ...
        <form className="mt-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <FormInput
            title="Roll Number (In the format-24/ME/001)"
            id="roll"
            isRequired={true}
            register={register}
          />
            ...
            <div className="py-5 px-6 lg:px-8 flex flex-col">
              ...
              <div className="flex flex-row mb-3 text-sm">
                <input
                  ...
                  {...register("position")}
                />
                <span className="w-2"></span>Content Writer/ Editor (Good
                english is a must)
              </div>
              <div className="flex flex-row mb-3 text-sm">
                <input
              ...
              <div className="flex flex-row mb-3 text-sm">
                <input
                  ...
                  {...register("position")}
                />
                <span className="w-2"></span>Photographer (Applicants with DSLR
                cameras will be preferred)
              </div>
              <div className="flex flex-row mb-3 text-sm">
                <input
                  className=""
