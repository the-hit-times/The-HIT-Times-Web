...
export default function DevForm() {
  ...
  const onSubmit = async (formData: DevSheetData) => {
    ...
    let all = "";
    if (formData.Q1_tech) {
      all = formData.Q1_tech.join(",");
    }
    formData.Q1_tech = all;

    all = "";
    if (formData.Q3_tech) {
      all = formData.Q3_tech.join(",");
    }
    formData.Q3_tech = all;

    formData.Q12_tech = formData.Q12_tech
      ? await uploadFile(formData.Q12_tech)
      : ""; //generate link
    ...
    <div className="min-h-screen bg-gray-200">
      <div className="max-w-3xl mx-auto">
        ...
        <form className="mt-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <FormInput
            title="Provide your GitHub link (if available)"
            id="Q6_tech"
            isRequired={false}
            register={register}
          />
          ...
          <FormInput
            title="Provide link of any project if you have made."
            id="Q11_tech"
            isRequired={false}
            register={register}
          />
          ...
          <FileUploader
            ...
            instruction="PPt, PDF, PNG, JPG or MS Word(MAX. 5 Mb )"
            id="Q12_tech"
            register={register}
          />
