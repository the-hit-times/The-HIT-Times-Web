        ...
        <form className="mt-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex flex-row bg-white bg-opacity-15 shadow-md rounded-lg mb-4">
            ...
            <div className="py-5 px-6 lg:px-8 flex flex-col">
              <label
                htmlFor="Q2_Q3_photo"
                className={poppins.className + " text-slate-300 text-md mb-4"}
              >
              ...
              <input
                className="border-b border-gray-300 bg-transparent focus:outline-none focus:border-purple-600 focus:border-b-2 py-1 focus:placeholder-purple-400"
          ...
          <div className="flex flex-row bg-white bg-opacity-15 shadow-md rounded-lg mb-4">
            ...
            <div className="py-5 px-6 lg:px-8 flex flex-col">
              ...
              <p
                className={
                  poppins.className +
                  " flex flex-row text-slate-300 text-md mb-3"
                }
              >
              ...
              <p
                className={
                  poppins.className + " flex flex-row text-slate-300 text-md "
                }
              >
                <div className="flex flex-row  text-sm">
                  <input
